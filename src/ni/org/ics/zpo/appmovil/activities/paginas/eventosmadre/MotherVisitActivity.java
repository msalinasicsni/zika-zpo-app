...
import ni.org.ics.zpo.appmovil.adapters.eventosmadre.VisitAdapter;
	...
	// ***************************************
		...
		private class FetchDataIngresoTask extends AsyncTask<String, Void, String> {
			...
			protected void onPostExecute(String resultado) {
				...
				gridView.setAdapter(new VisitAdapter(getApplicationContext(), R.layout.menu_item_2, menu_maternal_info, zp02));
