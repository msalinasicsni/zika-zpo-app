...
import ni.org.ics.zpo.appmovil.parsers.Zpo07InfantAssessmentVisitXml;
 ...
 * V1.0
 */
public class NewZpo07InfantAssessmentVisitOphtActivity extends AbstractAsyncActivity {
    protected static final String TAG = NewZpo07InfantAssessmentVisitOphtActivity.class.getSimpleName();

    private ZpoAdapter zipA;
    private static Zpo07InfantAssessmentVisit mInfantAssessment = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mInfantAssessment = (Zpo07InfantAssessmentVisit) getIntent().getExtras().getSerializable(Constants.OBJECTO_ZP07);
    ...
    private void createInitDialog() {
        ...
        if (mInfantAssessment !=null && mInfantAssessment.getPart2()!=null){
            message.setText(getString(R.string.edit)+ " " + getString(R.string.infant_b_3)+"?");
        }
        else{
            message.setText(getString(R.string.add)+ " " + getString(R.string.infant_b_3)+"?");
        }
        ...
        try{
            ...
            if(mInfantAssessment ==null){
                ...
                Cursor c = getContentResolver().query(Constants.CONTENT_URI, projection,
                        "jrFormId = 'zpo07_infant_assessment_ophtalmologist' and displayName = 'Estudio ZPO Visita de evaluacion al infante'", null, null);
                c.moveToFirst();
                ...
                //en caso que no  exista un registro de evaluacion de tipo oftalmologica
                if(mInfantAssessment.getPart2() == null){
                    //campos de proveedor de collect
                    String[] projection = new String[] {
                            "_id","jrFormId","displayName"};
                    //cursor que busca el formulario
                    ...
                    Integer id = mInfantAssessment.getIdInstancia2();
    ...
    private void parseZpo07InfantAssessmentVisit(Integer idInstancia2, String instanceFilePath, Integer accion) {
        ...
        try {
            Zpo07InfantAssessmentVisitXml zp07Xml = serializer.read(Zpo07InfantAssessmentVisitXml.class, source);
            if (accion== ADD_ZP07_ODK) mInfantAssessment = new Zpo07InfantAssessmentVisit();
            mInfantAssessment.setRecordId(mRecordId);
            mInfantAssessment.setEventName(event);
            mInfantAssessment.setInfantVisitDate2(zp07Xml.getInfantVisitDate2());
            mInfantAssessment.setInfantStatus2(zp07Xml.getInfantStatus2());
            mInfantAssessment.setInfantDeathDt2(zp07Xml.getInfantDeathDt2());
            mInfantAssessment.setInfantVisit2(zp07Xml.getInfantVisit2());
         ...
         /*   mInfantAssessment.setInfantOae(zp07Xml.getInfantOae());
            ...
            mInfantAssessment.setInfantCommentsYn2(zp07Xml.getInfantCommentsYn2());
            mInfantAssessment.setInfantComments2_2(zp07Xml.getInfantComments2_2());
            mInfantAssessment.setInfantIdCompleting2(username);
            mInfantAssessment.setInfantDtComp2(new Date());
            mInfantAssessment.setInfantIdReviewer2(username);
            ...
            try {
                ...
                try {
                    ...
                    if (accionaRealizar == ADD_ZP07_ODK){
                        zipA.crearZpo07InfantAssessmentVisit(mInfantAssessment);
                    }
                    else{
                        zipA.editarZpo07InfantAssessmentVisit(mInfantAssessment);
                    }
                    zipA.close();
                } catch (Exception e) {
