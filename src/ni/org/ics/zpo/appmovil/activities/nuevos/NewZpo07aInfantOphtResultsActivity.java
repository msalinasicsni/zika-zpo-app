...
import ni.org.ics.zpo.appmovil.parsers.Zpo07aInfantOphtResultsXml;
 ...
 * V1.0
 */
public class NewZpo07aInfantOphtResultsActivity extends AbstractAsyncActivity {
    protected static final String TAG = NewZpo07aInfantOphtResultsActivity.class.getSimpleName();

    private ZpoAdapter zipA;
    private static Zpo07aInfantOphtResults mInfantAssessment = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mInfantAssessment = (Zpo07aInfantOphtResults) getIntent().getExtras().getSerializable(Constants.OBJECTO_ZP07A);
        ...
        try {
            ...
            if (mInfantAssessment == null) {
                ...
                Cursor c = getContentResolver().query(Constants.CONTENT_URI, projection,
                        "jrFormId = 'zpo07a_infant_ophthalmologic_results' and displayName = 'Estudio ZPO - Resultados Oftalmologicos'", null, null);
                c.moveToFirst();
    ...
    private void parseZp07AInfantOpthResults(Integer idInstancia, String instanceFilePath, Integer accion) {
        ...
        try {
            Zpo07aInfantOphtResultsXml zp07aXml = serializer.read(Zpo07aInfantOphtResultsXml.class, source);
            if (accion== ADD_ZP07_ODK) mInfantAssessment = new Zpo07aInfantOphtResults();
            ...
            try {
                ...
                try {
                    ...
                    if (accionaRealizar == ADD_ZP07_ODK){
                        zipA.crearZpo07aInfantOphtResults(mInfantAssessment);
                    }
                    else{
                        zipA.editarZpo07aInfantOphtResults(mInfantAssessment);
                    }
                    zipA.close();
                } catch (Exception e) {
