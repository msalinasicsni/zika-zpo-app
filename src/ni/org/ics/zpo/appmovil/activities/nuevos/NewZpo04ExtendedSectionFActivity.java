...
import ni.org.ics.zpo.appmovil.parsers.Zpo04ExtendedSectionFXml;
 ...
 */
public class NewZpo04ExtendedSectionFActivity extends AbstractAsyncActivity {

    protected static final String TAG = NewZpo04ExtendedSectionFActivity.class.getSimpleName();

    private ZpoAdapter zipA;
    private static Zpo04ExtendedSectionF mZp04F = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mZp04F = (Zpo04ExtendedSectionF) getIntent().getExtras().getSerializable(Constants.OBJECTO_ZP04F);
        ...
        try{
			...
			if(mZp04F==null){
	            ...
	            Cursor c = getContentResolver().query(Constants.CONTENT_URI, projection,
	                    "jrFormId = 'zpo04_extended_f' and displayName = 'Estudio ZPO Cuestionario Extendido_F'", null, null);
	            c.moveToFirst();
    ...
    private void parseTrimesterVisit(Integer idInstancia, String instanceFilePath, Integer accion) {
        ...
        try {
            Zpo04ExtendedSectionFXml zp04Xml = new Zpo04ExtendedSectionFXml();
            zp04Xml = serializer.read(Zpo04ExtendedSectionFXml.class, source);
            if (accion==ADD_ZP04F_ODK) mZp04F = new Zpo04ExtendedSectionF();
            mZp04F.setRecordId(mRecordId);
            mZp04F.setEventName(event);
            ...
            try {
    			...
    			try {
    				...
    				if (accionaRealizar == ADD_ZP04F_ODK){
    					zipA.crearZpo04ExtendedSectionF(mZp04F);
    				}
    				else{
    					zipA.editarZpo04ExtendedSectionF(mZp04F);
    				}
    				zipA.close();
    			} catch (Exception e) {
