 ...
 * V1.0
 */
public class NewZpo08StudyExitActivity extends AbstractAsyncActivity {
    protected static final String TAG = NewZpo08StudyExitActivity.class.getSimpleName();

    private ZpoAdapter zpoA;
    private static Zpo08StudyExit mExit = new Zpo08StudyExit();
    ...
    private void addZp08StudyExit() {
        try{
            ...
            Cursor c = getContentResolver().query(Constants.CONTENT_URI, projection,
                    "jrFormId = 'zpo08_Study_Exit' and displayName = 'Estudio ZPO Salida del Estudio'", null, null);
            c.moveToFirst();
    ...
    private void parseZp08StudyExit(Integer idInstancia, String instanceFilePath) {
        ...
        try {
            Zpo08StudyExitXml zp08Xml = serializer.read(Zpo08StudyExitXml.class, source);
            mExit.setRecordId(mRecordId);
            mExit.setEventName(Constants.EXIT);
