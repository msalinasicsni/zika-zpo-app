...
import ni.org.ics.zpo.appmovil.parsers.Zpo07cInfantImageStudiesXml;
 ...
 * V1.0
 */
public class NewZpo07cInfantImageStudiesActivity extends AbstractAsyncActivity {
    protected static final String TAG = NewZpo07cInfantImageStudiesActivity.class.getSimpleName();

    private ZpoAdapter zipA;
    private static Zpo07cInfantImageStudies mInfantAssessment = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mInfantAssessment = (Zpo07cInfantImageStudies) getIntent().getExtras().getSerializable(Constants.OBJECTO_ZP07C);
        ...
        if(requestCode == ADD_ZP07_ODK ||requestCode == EDIT_ZP07_ODK) {
            if(resultCode == RESULT_OK) {
                ...
                if (complete.matches("complete")){
                    ...
                    parseZpo07cInfantImageStudies(idInstancia, instanceFilePath, accion);
                }
                else{
        ...
        try {
            ...
            if (mInfantAssessment == null) {
                ...
                Cursor c = getContentResolver().query(Constants.CONTENT_URI, projection,
                        "jrFormId = 'zpo07c_infant_imaging_studies' and displayName = 'Estudio ZPO - Resultados de Estudios de Imagenes'", null, null);
                c.moveToFirst();
    ...
    private void parseZpo07cInfantImageStudies(Integer idInstancia, String instanceFilePath, Integer accion) {
        Serializer serializer = new Persister();
        File source = new File(instanceFilePath);
        try {
            Zpo07cInfantImageStudiesXml zp07cXml = serializer.read(Zpo07cInfantImageStudiesXml.class, source);
            if (accion== ADD_ZP07_ODK) mInfantAssessment = new Zpo07cInfantImageStudies();
            ...
            try {
                ...
                try {
                    ...
                    if (accionaRealizar == ADD_ZP07_ODK){
                        zipA.crearZpo07cInfantImageStudies(mInfantAssessment);
                    }
                    else{
                        zipA.editarZpo07cInfantImageStudies(mInfantAssessment);
                    }
                    zipA.close();
                } catch (Exception e) {
