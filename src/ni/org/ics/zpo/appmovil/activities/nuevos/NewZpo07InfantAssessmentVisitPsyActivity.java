 ...
 * V1.0
 */
public class NewZpo07InfantAssessmentVisitPsyActivity extends AbstractAsyncActivity {
    protected static final String TAG = NewZpo07InfantAssessmentVisitPsyActivity.class.getSimpleName();
        ...
        try{
            ...
            if(mInfantAssessment ==null){
                ...
                if (mInfantAssessment.getPart3() == null) {
                    ...
                    //cursor que busca el formulario
                    Cursor c = getContentResolver().query(Constants.CONTENT_URI, projection,
                            "jrFormId = 'zpo07_infant_assessment_psychologist' and displayName = 'Estudio ZPO Visita de evaluacion al infante'", null, null);
                    c.moveToFirst();
                    //captura el id del formulario
                    Integer id = Integer.parseInt(c.getString(0));
                    //cierra el cursor
