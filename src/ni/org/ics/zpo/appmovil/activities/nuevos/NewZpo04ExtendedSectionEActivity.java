...
import ni.org.ics.zpo.appmovil.parsers.Zpo04ExtendedSectionEXml;
 ...
 */
public class NewZpo04ExtendedSectionEActivity extends AbstractAsyncActivity {

    protected static final String TAG = NewZpo04ExtendedSectionEActivity.class.getSimpleName();

    private ZpoAdapter zipA;
    private static Zpo04ExtendedSectionE mZp04E = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mZp04E = (Zpo04ExtendedSectionE) getIntent().getExtras().getSerializable(Constants.OBJECTO_ZP04E);
    	...
    	if(requestCode == ADD_ZP04E_ODK||requestCode == EDIT_ZP04E_ODK) {
            if(resultCode == RESULT_OK) {
                ...
                if (complete.matches("complete")){
                    ...
                    parseExtended(idInstancia, instanceFilePath, accion);
                }
                else{
        ...
        try{
			...
			if(mZp04E==null){
	            ...
	            Cursor c = getContentResolver().query(Constants.CONTENT_URI, projection,
	                    "jrFormId = 'zpo04_extended_e' and displayName = 'Estudio ZPO Cuestionario Extendido_E'", null, null);
	            c.moveToFirst();
    ...
    private void parseExtended(Integer idInstancia, String instanceFilePath, Integer accion) {
        Serializer serializer = new Persister();
        File source = new File(instanceFilePath);
        try {
            Zpo04ExtendedSectionEXml zp04Xml = new Zpo04ExtendedSectionEXml();
            zp04Xml = serializer.read(Zpo04ExtendedSectionEXml.class, source);
            if (accion==ADD_ZP04E_ODK) mZp04E = new Zpo04ExtendedSectionE();
            mZp04E.setRecordId(mRecordId);
            mZp04E.setEventName(event);
        ...
        protected String doInBackground(Integer... values) {
			...
			try {
				...
				if (accionaRealizar == ADD_ZP04E_ODK){
					zipA.crearZpo04ExtendedSectionE(mZp04E);
				}
				else{
					zipA.editarZpo04ExtendedSectionE(mZp04E);
				}
				zipA.close();
			} catch (Exception e) {
