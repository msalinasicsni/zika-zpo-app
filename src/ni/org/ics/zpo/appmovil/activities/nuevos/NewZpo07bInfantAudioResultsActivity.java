...
import ni.org.ics.zpo.appmovil.parsers.Zpo07bInfantAudioResultsXml;
 ...
 * V1.0
 */
public class NewZpo07bInfantAudioResultsActivity extends AbstractAsyncActivity {
    protected static final String TAG = NewZpo07bInfantAudioResultsActivity.class.getSimpleName();

    private ZpoAdapter zipA;
    private static Zpo07bInfantAudioResults mInfantAssessment = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mInfantAssessment = (Zpo07bInfantAudioResults) getIntent().getExtras().getSerializable(Constants.OBJECTO_ZP07B);
        ...
        if(requestCode == ADD_ZP07_ODK ||requestCode == EDIT_ZP07_ODK) {
            if(resultCode == RESULT_OK) {
                ...
                if (complete.matches("complete")){
                    ...
                    parseZpo07bInfantAudioResults(idInstancia, instanceFilePath, accion);
                }
                else{
        ...
        try {
            ...
            if (mInfantAssessment == null) {
                ...
                Cursor c = getContentResolver().query(Constants.CONTENT_URI, projection,
                        "jrFormId = 'zpo07b_infant_audiologic_results' and displayName = 'Estudio ZPO - Resultados de examenes Audiologicos'", null, null);
                c.moveToFirst();
    ...
    private void parseZpo07bInfantAudioResults(Integer idInstancia, String instanceFilePath, Integer accion) {
        Serializer serializer = new Persister();
        File source = new File(instanceFilePath);
        try {
            Zpo07bInfantAudioResultsXml zp07bXml = serializer.read(Zpo07bInfantAudioResultsXml.class, source);
            if (accion== ADD_ZP07_ODK) mInfantAssessment = new Zpo07bInfantAudioResults();
            ...
            try {
                ...
                try {
                    ...
                    if (accionaRealizar == ADD_ZP07_ODK){
                        zipA.crearZpo07bInfantAudioResults(mInfantAssessment);
                    }
                    else{
                        zipA.editarZpo07bInfantAudioResults(mInfantAssessment);
                    }
                    zipA.close();
                } catch (Exception e) {
