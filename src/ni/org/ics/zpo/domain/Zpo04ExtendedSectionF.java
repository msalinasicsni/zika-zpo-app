 ...
 * V1.0
 */
public class Zpo04ExtendedSectionF extends BaseMetaData {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Zpo04ExtendedSectionF)) return false;

        Zpo04ExtendedSectionF that = (Zpo04ExtendedSectionF) o;
