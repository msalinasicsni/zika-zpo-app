 ...
 */
public class Zpo07bInfantAudioResults extends BaseMetaData {
    ...
    public String toString() {
        return "ZPO07b{" + recordId + ", " + eventName + "}";
    }

    @Override
    public boolean equals(Object o) {
        if (this == o) return true;
        if (!(o instanceof Zpo07bInfantAudioResults)) return false;

        Zpo07bInfantAudioResults that = (Zpo07bInfantAudioResults) o;
