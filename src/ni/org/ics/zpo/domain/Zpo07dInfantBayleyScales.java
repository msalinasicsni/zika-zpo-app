 ...
 */
public class Zpo07dInfantBayleyScales extends BaseMetaData {
    ...
    public String toString() {
        return "ZPO07d{" + recordId + ", " + eventName + "}";
    }

    @Override
    public boolean equals(Object o) {
        if (this == o) return true;
        if (!(o instanceof Zpo07dInfantBayleyScales)) return false;

        Zpo07dInfantBayleyScales that = (Zpo07dInfantBayleyScales) o;
